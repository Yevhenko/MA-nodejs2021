...
function handleArray(inputArray, outputArray) {
...
function jsonOptimizer(filename) {
  return new Promise((resolve, reject) => {
    ...
    inputStream.on('end', async () => {
      const totalQuantity = outputProducts.reduce((acc, current) => acc + current.quantity, 0);
